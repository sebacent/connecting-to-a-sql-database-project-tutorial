...
connection_string = f"postgresql://{os.getenv('gitpod')}:{os.getenv('postgres')}@{os.getenv('localhost')}/{os.getenv('sebaDB')}"
engine = create_engine("postgresql://gitpod:postgres@localhost:5432/sebaDB")
engine.connect()
